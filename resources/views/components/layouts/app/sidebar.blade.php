<div class="border-e border-zinc-200 dark:border-zinc-700 h-screen p-4 bg-zinc-50 dark:bg-zinc-900 flex flex-col">
    ...
    <nav class="flex-1 px-4 py-6 overflow-y-auto text-sm">
        <ul class="space-y-2">
            ...
            <li x-data="{ open: {{ (request()->routeIs('employee.*')) ? 'true' : 'false' }} }">
                <div class="flex flex-col">
                    ...
                    <div x-show="open" class="mt-2 ms-4 space-y-1" style="display: none;">
                        @can('manage_employee')
                        <a href="{{ route('employee.index') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('employee.index') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Manage Employees') }}</a>
                        @endcan
                        @can('create_employee')
                        <a href="{{ route('employee.show') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('employee.show') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Add Employee') }}</a>
                        @endcan
                    </div>
                </div>
            </li>
            ...
            <li x-data="{ open: {{ (request()->routeIs('user.*')) ? 'true' : 'false' }} }">
                <div class="flex flex-col">
                    <button type="button" @click="open = !open" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('user.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}">
                    ...
                    <div x-show="open" class="mt-2 ms-4 space-y-1" style="display: none;">
                        @can('manage_user')
                        <a href="{{ route('user.index') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('user.index') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Manage Users') }}</a>
                        @endcan
                        @can('create_user')
                        <a href="{{ route('user.show') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('user.show') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Add User') }}</a>
                        @endcan
                    </div>
                </div>
            </li>
            ...
            <li x-data="{ open: {{ (request()->routeIs('job.*') && !request()->routeIs('careers.*')) ? 'true' : 'false' }} }">
                <div class="flex flex-col">
                    <button type="button" @click="open = !open" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('job.*') && !request()->routeIs('careers.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}">
                    ...
                    <div x-show="open" class="mt-2 ms-4 space-y-1" style="display: none;">
                        <a href="{{ route('job.index') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('job.index') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Job Adverts') }}</a>
            ...
            <li>
                <a href="{{ route('role.index') }}" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('role.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>
            ...
            <li x-data="{ open: {{ (request()->routeIs('location.*') || request()->routeIs('branch.*') || request()->routeIs('department.*') || request()->routeIs('designation.*')) ? 'true' : 'false' }} }">
                <div class="flex flex-col">
                    <button type="button" @click="open = !open" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('location.*') || request()->routeIs('branch.*') || request()->routeIs('department.*') || request()->routeIs('designation.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}">
                        <span class="flex items-center rounded-full font-black bg-gray-200 dark:bg-zinc-700 p-2 {{ request()->routeIs('location.*') || request()->routeIs('branch.*') || request()->routeIs('department.*') || request()->routeIs('designation.*') ? 'bg-white dark:bg-zinc-900' : 'dark:bg-zinc-500' }}">
                    ...
                    <div x-show="open" class="mt-2 ms-4 space-y-1" style="display: none;">
                        @can('manage_location')
                        <a href="{{ route('location.manage') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('location.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Locations') }}</a>
                        @endcan
                        @can('manage_branch')
                        <a href="{{ route('branch.manage') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('branch.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Branches') }}</a>
                        @endcan
                        @can('manage_department')
                        <a href="{{ route('department.manage') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('department.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Departments') }}</a>
                        @endcan
                        @can('manage_designation')
                        <a href="{{ route('designation.manage') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('designation.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Designations') }}</a>
                        @endcan
                    </div>
                </div>
            </li>
            ...
            <li>
                <a href="{{ route('clock.manage') }}" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('clock.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>
            ...
            <li>
                <a href="{{ route('attendance.manage') }}" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('attendance.manage') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>
            ...
            <li x-data="{ open: {{ (request()->routeIs('own-leave.*') || request()->routeIs('leave.apply')) ? 'true' : 'false' }} }">
                <div class="flex flex-col">
                    <button type="button" @click="open = !open" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('own-leave.*') || request()->routeIs('leave.apply') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}">
                    ...
                    <div x-show="open" class="mt-2 ms-4 space-y-1" style="display: none;">
                        <a href="{{ route('own-leave.manage') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('own-leave.manage') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('My Leave') }}</a>
                        <a href="{{ route('leave.apply') }}" class="px-3 py-1.5 flex items-center gap-2 transition-colors rounded-full font-semibold {{ request()->routeIs('leave.apply') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>{{ __('Apply Leave') }}</a>
                    </div>
                </div>
            </li>
            @endif
            ...
            <li>
                <a href="{{ route('all-leave.manage') }}" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('all-leave.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>
            ...
            <li>
                <a href="{{ route('wellbeing.dashboard') }}" class="flex items-center gap-2 px-1 py-1 transition-colors rounded-full font-semibold {{ request()->routeIs('wellbeing.*') ? 'bg-green-600 dark:bg-green-700 text-white dark:text-zinc-200' : 'text-zinc-700 dark:text-zinc-200 hover:bg-zinc-300/50 dark:hover:bg-zinc-800' }}" wire:navigate>
    ...
    <div class="border-t border-zinc-200 dark:border-zinc-700 p-4">
        ...
        <div class="flex flex-col gap-2">
            <a href="{{ route('settings.profile') }}" class="flex items-center gap-2 px-3 py-2 text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg transition-colors" wire:navigate>
