...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <flux:sidebar stashable sticky class="bg-zinc-50/20 dark:bg-zinc-900/20 w-full backdrop-blur-sm !p-0">
            <div class="border-e border-zinc-200 dark:border-zinc-700 w-fit lg:w-64 h-screen p-4 bg-zinc-50 dark:bg-zinc-900 flex flex-col">
                    ...
                    <flux:menu class="w-[220px]">
                        ...
                        <flux:menu.radio.group>
                            ...
                            <flux:menu.item 
                                ...
                                icon="language"
                                class="{{ app()->getLocale() === $language->code ? 'bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300' : '' }}"
                            >
