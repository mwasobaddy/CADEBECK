...
<head>
    ...
    <style>
        ...
        .allowances-table { background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border: 1px solid #16a34a; }
        .allowances-table th { background: #166534; color: white; }
        .deductions-table { background: linear-gradient(135deg, #fef2f2 0%, #fee2e2 100%); border: 1px solid #dc2626; }
        .deductions-table th { background: #991b1b; color: white; }
