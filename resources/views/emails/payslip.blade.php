...
<head>
    ...
    <title>{{ __('Payslip') }} - {{ config('app.name') }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="message-content">
            ...
            <p>{{ __('Your payslip for the period :period is ready. Please find your salary details below.', ['period' => $payroll->payroll_period ?? 'N/A']) }}</p>
