...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    {
        // Ensure the payroll belongs to the current user's employee record
        $payroll = Payroll::where('id', $payrollId)
            ->where('employee_id', $this->employee->id)
            ->first();

        if (!$payroll) {
            abort(403, 'Access denied. You can only view your own payroll details.');
        }
                    ...
                    @else
                        ...
                        <td class="px-4 py-4 text-gray-900 dark:text-white font-medium">
                            <span class="text-blue-600 dark:text-blue-400">
                                GBP {{ number_format($payroll->basic_salary, 2) }}
                            </span>
                        </td>
                        <td class="px-4 py-4 text-gray-900 dark:text-white font-medium">
                            <span class="text-green-600 dark:text-green-400">
                                @if($payroll->status === 'draft')
                                    {{ __('Draft') }}
                                @else
                                    +GBP {{ number_format($payroll->total_allowances, 2) }}
                                @endif
                            </span>
                        </td>
                        <td class="px-4 py-4 text-gray-900 dark:text-white font-medium">
                            <span class="text-red-600 dark:text-red-400">
                                @if($payroll->status === 'draft')
                                    {{ __('Draft') }}
                                @else
                                    -GBP {{ number_format($payroll->total_deductions, 2) }}
                                @endif
                            </span>
                        </td>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-4 border border-green-200 dark:border-green-800">
                        ...
                        <p class="text-xl font-bold text-green-600 dark:text-green-400">
                            GBP {{ number_format($selectedPayroll->net_pay, 2) }}
                        </p>
                    </div>
                </div>
                    ...
                    <div class="bg-white dark:bg-zinc-800/50 rounded-xl p-6 border border-gray-200 dark:border-zinc-700">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-blue-600 dark:text-blue-400">GBP {{ number_format($selectedPayroll->basic_salary, 2) }}</span>
                            </div>

                            @if($selectedPayroll->house_allowance > 0)
                            <div class="flex justify-between items-center py-2">
                                <span class="text-gray-600 dark:text-gray-400">{{ __('House Allowance') }}</span>
                                <span class="font-semibold text-green-600 dark:text-green-400">+GBP {{ number_format($selectedPayroll->house_allowance, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-green-600 dark:text-green-400">+GBP {{ number_format($selectedPayroll->transport_allowance, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-green-600 dark:text-green-400">+GBP {{ number_format($selectedPayroll->medical_allowance, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-green-600 dark:text-green-400">+GBP {{ number_format($selectedPayroll->other_allowances, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-green-600 dark:text-green-400">+GBP {{ number_format($selectedPayroll->overtime_amount, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-green-600 dark:text-green-400">+GBP {{ number_format($selectedPayroll->bonus_amount, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-3 mt-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-bold text-lg text-purple-600 dark:text-purple-400">GBP {{ number_format($selectedPayroll->gross_pay, 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-zinc-800/50 rounded-xl p-6 border border-gray-200 dark:border-zinc-700">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-red-600 dark:text-red-400">-GBP {{ number_format($selectedPayroll->paye_tax, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-red-600 dark:text-red-400">-GBP {{ number_format($selectedPayroll->nhif_deduction, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-red-600 dark:text-red-400">-GBP {{ number_format($selectedPayroll->nssf_deduction, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-red-600 dark:text-red-400">-GBP {{ number_format($selectedPayroll->insurance_deduction, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-red-600 dark:text-red-400">-GBP {{ number_format($selectedPayroll->loan_deduction, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="font-semibold text-red-600 dark:text-red-400">-GBP {{ number_format($selectedPayroll->other_deductions, 2) }}</span>
                            </div>
                            @endif
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-3 mt-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-bold text-lg text-red-600 dark:text-red-400">-GBP {{ number_format($selectedPayroll->total_deductions, 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-3">
                                @foreach($linkedAllowances as $allowance)
                                    <div class="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                        ...
                                        <span class="font-semibold text-green-600 dark:text-green-400">GBP {{ number_format($allowance->amount, 2) }}</span>
                                    </div>
                                @endforeach
                            </div>
                        @else
                            ...
                            <div class="space-y-3">
                                @foreach($linkedDeductions as $deduction)
                                    <div class="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                                        ...
                                        <span class="font-semibold text-red-600 dark:text-red-400">GBP {{ number_format($deduction->amount, 2) }}</span>
                                    </div>
                                @endforeach
                            </div>
                        @else
