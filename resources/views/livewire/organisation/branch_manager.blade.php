...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    public function editConfirmed(): void
    {
        ...
        $this->redirectRoute('branch.branch_edit', ['id' => $branch->id]);
    }
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-white/20 transition group border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <td class="px-5 py-4">
                                        <span class="flex gap-2">
                                            @can('edit_branch')
                                                <button wire:click="confirmEdit({{ $branch->id }})"
                                                    class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
                                            ...
                                            @can('delete_branch')
                                                <button wire:click="confirmDelete({{ $branch->id }})"
                                                    class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-red-50 text-red-700 hover:bg-red-100 border border-red-200 focus:outline-none focus:ring-2 focus:ring-red-500 transition">
                                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                    </svg>
                                                    {{ __('Delete') }}
