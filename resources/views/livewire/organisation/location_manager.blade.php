...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    {
        // In this scaffold we don't assume route names or models. Toggle modal off.
    ...
    {
        // Remove pending id from selected if present and close modal. Actual deletion should be implemented later.
    ...
    <div class="relative z-10 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl rounded-xl shadow-2xl p-6 transition-all duration-300 hover:shadow-3xl border border-blue-100 dark:border-zinc-800 ring-1 ring-blue-200/30 dark:ring-zinc-700/40">
        ...
        <div class="flex flex-wrap gap-8 items-center">
            <div class="relative w-80">
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search locations..." class="w-full px-4 py-3 rounded-2xl border" />
            </div>
        ...
        <div class="overflow-x-auto bg-transparent mt-6">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody>
                    <tr>
                        <td colspan="5" class="p-6 text-center text-zinc-500">No locations found.</td>
                    </tr>
                </tbody>
            </table>
    ...
    @if ($showDeleteModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl p-8 max-w-md w-full">
                ...
                <p class="mb-6 text-zinc-700">Are you sure you want to delete this location? This action cannot be undone.</p>
    ...
    @if ($showEditModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl p-8 max-w-md w-full">
                ...
                <p class="mb-6 text-zinc-700">Are you sure you want to edit this location?</p>
                <div class="flex justify-end gap-3">
