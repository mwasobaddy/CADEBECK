...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    public function exportCsv($scope = 'all')
    {
        ...
        $headers = ['ID', 'Name', 'Branch', 'Code', 'Created At'];
        $filename = $scope === 'selected' ? 'selected_departments_' . now()->format('Y-m-d_H-i-s') . '.csv' : 'all_departments_' . now()->format('Y-m-d_H-i-s') . '.csv';
    ...
    public function exportPdf($scope = 'all')
    {
        ...
        $filename = $scope === 'selected' ? 'selected_departments_' . now()->format('Y-m-d_H-i-s') . '.pdf' : 'all_departments_' . now()->format('Y-m-d_H-i-s') . '.pdf';
    ...
    {
        if ($scope === 'selected') {
            return Department::whereIn('id', $this->selected);
        }
