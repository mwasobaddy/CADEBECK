...
<div class="space-y-6">
    ...
    <div class="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        <div class="flex items-start">
            ...
            <div>
                <h4 class="text-sm font-medium text-gray-800 dark:text-gray-200">Need help?</h4>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">If you continue to have issues, please contact your system administrator.</p>
            </div>
        </div>
    </div>
</div>
