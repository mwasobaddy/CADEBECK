...
class PayrollPaidNotification extends Notification
{
    ...
    public function __construct(Payroll $payroll, ?string $subject = null, ?string $message = null)
    {
        ...
        $this->subject = $subject ?? 'Your Payroll Has Been Paid - ' . $payroll->payroll_period;
        $this->message = $message ?? 'Your payroll has been processed and paid successfully. Your complete payslip details are shown below.';
    }
